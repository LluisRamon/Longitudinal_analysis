...
print(xtable(taula, label="anovas:Random_slope_intercept", caption="Anova table comparing the Fixed effects model (no random effects) with the random intercept and the random slope models."), comment = FALSE)
```
