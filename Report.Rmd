...
In this section a Random-effects model is performed. The methodology that is taken

1. Model for the fixed effects
2. Include a Random effect
3. Add a correlation structure
