...
Parameter estimates for $\beta_{0ij}$ are included in Table \label{tab::Two_stage_intercept} with it corresponding p-value. The intercept (15.1300) represents the mean PCV value at time 1 for a cow treated with low dose, as it is the reference treatment. The parameter estimate for medium dose is not significant.
...
Parameters   & Estimate (p-value)       \\ 
\hline
$\beta_{4}$ (Intercept)   & 2.1500 (0.000438)  \\
$\beta_{5}$ (doseMedium) &  0.4500 (0.540909)  \\
$\beta_{6}$ (doseHigh)  &  2.6300 (0.001083)  \\      
\end{tabular}
