...
To clarify the dataset and in a way that assumptions are no longer needed, one could contact the person who collected the data. Adding some covariates may also help futur researchers predict PCV values based on the initial condition of a given cow.
