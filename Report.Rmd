...
print(xtable(cor(cows.w[, c("1", "2", "3")], use = "pairwise.complete.obs"), caption = "TODO(Mathieu)"), comment = FALSE, table.placement = "H", include.rownames = FALSE)
```
...
print(xtable(taula, label="intervals", caption="Summary of the estimations for the parameters for the random slope model adding the number of births."), include.rownames = FALSE, comment = FALSE, table.placement = "H")
