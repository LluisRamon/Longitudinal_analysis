...
```{r slope_graph, fig.cap = "TODO(Mathieu) Something about the plot \\label{slope_graph}", fig.pos = "H", fig.height = 4, fig.width = 6}
...
```{r random_graph, fig.cap= "TODO(Mathieu). \\label{random_graph}", fig.height = 4, fig.width = 6, fig.pos = "H"}
